package pl.gpiwosz.accountancy.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, pl.gpiwosz.accountancy.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, pl.gpiwosz.accountancy.repository.UserRepository.USERS_BY_EMAIL_CACHE);
