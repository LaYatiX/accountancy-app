      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dt>
              <span id="priceNetto">Price Netto</span>
            </dt>
            <dd>{productEntity.priceNetto}</dd>
            <dt>
              <span id="vAT">V AT</span>
            </dt>
            <dd>{productEntity.vAT}</dd>
            <dt>
              <span id="priceBrutto">Price Brutto</span>
            </dt>
            <dd>{productEntity.priceBrutto}</dd>
          </dl>
