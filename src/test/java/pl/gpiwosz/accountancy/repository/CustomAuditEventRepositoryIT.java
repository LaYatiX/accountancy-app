...
import pl.gpiwosz.accountancy.config.audit.AuditEventConverter;
import pl.gpiwosz.accountancy.domain.PersistentAuditEvent;
...
import static pl.gpiwosz.accountancy.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
